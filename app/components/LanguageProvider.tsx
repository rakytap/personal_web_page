...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        detectorLpuVideoTitle: 'Detector-to-LPU pipeline on Groq GC1 (SLAC–ELTE)',
        detectorLpuVideoDescription:
            'Joint work by SLAC and ELTE presents a fully pipelined detector-to-LPU framework on the Groq GC1 card: a direct QSFP link connects non-deterministic detector inputs to deterministic LPU compute. The demonstration brings DIII-D CAKE-NN inference to about 10 μs end-to-end latency, with an FPGA-based controller between detector systems and the LPU that mediates timing and data flow.',
        detectorLpuVideoFeature1: 'Fully pipelined data transfer from detectors through an FPGA controller layer to Groq LPU hardware',
        detectorLpuVideoFeature2: 'QSFP link bridges non-deterministic detector-side traffic with deterministic, cycle-accurate LPU execution',
        detectorLpuVideoFeature3: 'DIII-D CAKE-NN inference benchmarked at ~10 μs end-to-end latency on the integrated stack',
        detectorLpuVideoFeature4: 'FPGA layer interfaces laboratory detector systems with production LPU cards for reproducible real-time inference',
    ...
    hu: {
        ...
        detectorLpuVideoTitle: 'Detektor–LPU csővezeték Groq GC1-en (SLAC–ELTE)',
        detectorLpuVideoDescription:
            'Az SLAC és az ELTE közös munkája egy teljesen folyamatba szervezett detektor–LPU keretrendszert mutat be a Groq GC1 kártyán: közvetlen QSFP összeköttetés köti össze a nem determinisztikus detektor bemeneteket a determinisztikus LPU számítással. A bemutató a DIII-D CAKE-NN következtetést körülbelül 10 μs végpont–végpont késleltetésre hozza, FPGA alapú vezérlőréteggel a detektorrendszerek és az LPU között, amely időzítést és adatfolyamot egyeztet.',
        detectorLpuVideoFeature1: 'Teljesen folyamatba szervezett adatátvitel detektoroktól FPGA vezérlőn keresztül a Groq LPU hardverig',
        detectorLpuVideoFeature2: 'QSFP kapcsolat a nem determinisztikus detektor oldali forgalom és a determinisztikus, ciklus pontos LPU végrehajtás között',
        detectorLpuVideoFeature3: 'DIII-D CAKE-NN következtetés ~10 μs végpont–végpont késleltetéssel az integrált rendszeren',
        detectorLpuVideoFeature4: 'FPGA réteg illeszti a labor detektorrendszereit a gyártási LPU kártyákhoz reprodukálható valós idejű következtetéshez',
        viewOnYouTube: 'Megnézés YouTube-on',
