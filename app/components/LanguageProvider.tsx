...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        homeSubtitle: 'Senior Research Fellow, Senior Software Engineer and Forensic Physics Expert',
    ...
    hu: {
        ...
        homeSubtitle: 'Főiskolai Kutató, Senior Szoftvermérnök és Kriminalisztikai Fizikai Szakértő',
        seniorResearchFellowTitle: 'Főiskolai Kutató',
        seniorResearchFellowContent: 'Tapasztalt és innovatív vezető kutatóként több mint tíz év szakmai múlttal rendelkezem a kvantumszámítás és a nagy teljesítményű számítástechnika (HPC) területén. Munkám során kvantumos gépi tanulási algoritmusokat, hardveremulációs keretrendszereket, valamint fejlett architekturális megoldásokat fejlesztek, amelyek hozzájárulnak a következő generációs kvantumalkalmazások fejlődéséhez.',
        seniorSoftwareEngineerTitle: 'Senior Szoftvermérnök',
        seniorSoftwareEngineerContent: 'Szilárd fizikai és programozási háttérrel, valamint bizonyított szakmai eredményekkel rendelkezem, melyek révén innovatív megoldásokat valósítok meg. Megbízható, együttműködő csapatjátékos vagyok, erős kommunikációs és problémamegoldó készségekkel. Hatékonyan kezelem a párhuzamos feladatokat, miközben pozitív és proaktív hozzáállással dolgozom.',
        forensicPhysicsExpertTitle: 'Kriminalisztikai Fizikai Szakértő',
        forensicPhysicsExpertContent: 'Motivált vagyok új kihívások vállalására és arra, hogy értékes hozzájárulást nyújtsak ambiciózus mérnöki projektekhez. Fizikai és számítási módszerekkel kapcsolatos szakértelmem lehetővé teszi, hogy értékes betekintést és megoldásokat nyújtsak a kriminalisztikai fizikai alkalmazásokban.',
