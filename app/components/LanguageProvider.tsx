...
const translations: Record<Language, Record<string, string>> = {
    ...
    hu: {
        ...
        experienceContent: 'Senior Kutató és Senior Szoftvermérnök vagyok, több mint 10 év tapasztalattal a kvantumszámítás és nagy teljesítményű számítás (HPC) területén. Szakértelemem magában foglalja a kvantum gépi tanulási algoritmusok fejlesztését, hardver emulációs keretrendszerek létrehozását és fejlett architektúrális funkciók tervezését. Specializálódom a Groq chip programozásában és adatfolyam alkalmazások fejlesztésében FPGA platformokon számítási feladatok gyorsításához. Erős fizikai és szoftvermérnöki háttérrel rendelkezem, bevált tapasztalattal projekt koordinációban, csapatmunkában és innovatív megoldások készítésében.',
        ...
        seniorResearchFellowContent: 'Kutató vagyok, aki több mint 10 év tapasztalattal rendelkezik a kvantumszámítás és nagy teljesítményű számítás (HPC) területén. Szakértelemem magában foglalja a kvantum gépi tanulási algoritmusok fejlesztését, hardver emulációs keretrendszerek létrehozását és fejlett architektúrális funkciók tervezését.',
        seniorSoftwareEngineerTitle: 'Senior Szoftvermérnök',
        seniorSoftwareEngineerContent: 'Szoftvermérnök vagyok, aki több mint 10 év tapasztalattal rendelkezik a szoftverfejlesztés területén. Szakértelemem magában foglalja a kvantum gépi tanulási algoritmusok fejlesztését, hardver emulációs keretrendszerek létrehozását és fejlett architektúrális funkciók tervezését.',
        ...
        algorithmDeveloper: 'Munkám magában foglalja a kvantum gépi tanulási algoritmusok fejlesztését, hardver emulációs keretrendszerek létrehozását, és olyan fejlett architektúrális funkciók tervezését, amelyek támogatják a következő generációs kvantum alkalmazásokat.',
        ...
        groqChipProgramming: 'A Groq chip programozásában specializálódom nagy teljesítményű alkalmazásokhoz, kihasználva egyedi adatfolyam architektúrájukat kvantumszámítási alkalmazások, hardver emulációs keretrendszerek és architektúra verifikációs rendszerek fejlesztéséhez.',
